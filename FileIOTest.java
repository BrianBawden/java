...
// {//open FileIOTest class
//     static StringBuffer StringBufferOfData = new StringBuffer();
//     static String filename = null;
//     static Scanner sc = new Scanner(system.in); // get user input.

//     public static void main(String[] args)
//     {//start main
//         boolean fileRead = readFile(); //call the readFile method.

//         if(fileRead)
//         {//start fileRead if statement
//             replacement(); //module to get replacement text.

//             writeToFile();

//             fileRead.close();
//         }//end fileRead if statement
//     }//end main

//     private static boolean readFile()
//     {//Start readFile
//         System.out.println("Enter path to file name: ");
//         filename = sc.nextLine();//read in the file name
//         Scanner fileToRead = null;
//         try
//         {//start try
//             fileToRead = new Scanner(new File(filename));//point scanner to file
